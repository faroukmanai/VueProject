          ...
          <div class="col-sm-12">
            ...
            <div class="needs-validation" novalidate>
              <div class="row g-2">
                ...
                <button class="w-100 btn btn-success btn-lg mt-3" type="button" @click="updateProduct">Modifer </button>
                </div>
                <div v-if="submitted">
  ...
  methods: {
    updateProduct () {
      ProductDataService.update(this.id, this.product)
        ...
        .catch(error => {
          console.error('Une erreur est survenue lors de la mise à jour du produit : ', error)
        })
    }
  },
  mounted () {
